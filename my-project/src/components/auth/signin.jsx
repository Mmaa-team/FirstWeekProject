        ...
        <div className=' flex justify-center flex-col lg:flex-row items-center h-screen  '>
            ...
            <div className=" flex-col w-fit  ml-10 h-fit bg-white bg-opacity-20 rounded-[10px] p-5" >
                ...
                <div><span className=" text-gray-600 text-lg font-normal font-['SF Pro Display'] tracking-tight">new User?</span>
                    ...
                    <span className="text-[#733709] text-lg font-medium font-['SF Pro Display'] tracking-tight" onClick={() => { navigate('/signup') }}>Create Account</span></div>
                ...
                {desplayp && <button onClick={() => setDesplayp(false)}
                    className="bg-[#733709] mg-5  text-white px-4  mt-3 float-right rounded-full transition duration-200 ease-in-out hover:bg-[#DC9D6D] active:bg-[#B27F58] focus:outline-none"
                >
                    continue
                </button>}
